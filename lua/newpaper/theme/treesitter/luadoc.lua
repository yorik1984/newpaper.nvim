...
function M.setup(configColors, configStyle)
    ...
    return {
        ...
        ["@constructor.bracket.luadoc"]   = { fg = newpaper.lua_blue, style = style.doc_k_style, nocombine = true },
        ...
        ["@operator.luadoc"]              = { fg = newpaper.navy, style = style.doc_style, nocombine = true },
        ...
        ["@storageclass.luadoc"]          = { fg = newpaper.navy, style = style.doc_style, nocombine = true },
        ...
        ["@type.luadoc"]                  = { fg = newpaper.neovim_green, style = style.doc_style, nocombine = true },
