...
function M.setup(configColors, configStyle)
    ...
    lspSyn.loadPlugins = function()
        local plugins = {
            ...
            DiagnosticSignError        = { fg = newpaper.error_fg, bg = newpaper.none },
            DiagnosticSignHint         = { fg = newpaper.hint_fg,  bg = newpaper.none },
            DiagnosticSignInfo         = { fg = newpaper.info_fg,  bg = newpaper.none },
            DiagnosticSignWarn         = { fg = newpaper.warn_fg,  bg = newpaper.none },
            DiagnosticSignOk           = { fg = newpaper.ok_fg,    bg = newpaper.none },
